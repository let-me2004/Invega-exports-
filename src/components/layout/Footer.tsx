        ...
        <div className="md:fixed bottom-0 left-0 w-full h-auto md:h-[90vh] md:min-h-[700px] bg-white text-black rounded-t-[40px] shadow-[0_-20px_50px_rgba(0,0,0,0.3)] flex flex-col overflow-hidden relative">
          ...
          <div className="w-full flex-1 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 px-6 md:px-12 z-10 relative pb-12 md:pb-0">
            ...
            <div className="md:col-span-1">
              ...
              <p className="leading-relaxed mb-6 font-light text-[#737373] text-sm md:text-base">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full flex justify-center items-end pointer-events-none z-0 select-none overflow-hidden pb-4 opacity-50 md:opacity-100">
            <span className="premium-heading text-[12vw] md:text-[10vw] text-black/[0.03] whitespace-nowrap leading-none">
              INVEGA EXPORTS
            </span>
          </div>
